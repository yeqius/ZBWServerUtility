...
public class WebRequestExample : MonoBehaviour
{
    ...
    private string FileString = "https://cosbrowser.cloud.tencent.com/share/?id=M6W5h302Z3W1Rfn3M2D0B1z4&token=Sv%2BPmc6Wzzt3d%2B9XshzMqXnpgDBn0xZdboJLGZWLpTmZCgSOVMU8fHftfgs6mwW2";
    ...
    public void Start()
    {
        ...
        // StartCoroutine(GetCurrinstance());
        //StartCoroutine(BUY());
        //BuyAndGetCurrinstance();
        //StartServerAndSerchInstance();
        StartCoroutine(StartDownLoad());
    }
    IEnumerator StartDownLoad()
    {
        // 创建一个WebRequest对象
        UnityEngine.Networking.UnityWebRequest www = UnityEngine.Networking.UnityWebRequest.Get(FileString);
        ...
        {
            Debug.LogError("下载文件时出现错误: " + www.error);
        }
        else
        {
            // 将下载的文件保存到本地
